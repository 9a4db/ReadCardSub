		...
		if (len==ARRYLEN)
		{
			...
			switch(rrv[ACTTXID])
			{
				case 1 : 
					...
					set1[PHASEOFFSETACK]=lrv[PHASEOFFSETACK];			//TX发送时间
					...
					set1[PHASEOFFSETDATA]=rrv[PHASEOFFSETDATA];			//RX接收时间
				...
				case 2 :
					...
					set2[PHASEOFFSETACK]=rrv[PHASEOFFSETACK];			//RX回送时间
					...
					set2[PHASEOFFSETDATA]=lrv[PHASEOFFSETDATA];			//TX接收回送时间
